    ...
    <div style={s.layout}>
      ...
      <main style={s.main}>
        <Navbar
          ...
          subtitle="Found something? Help reunite it with its owner"
        />
        ...
        <div style={s.content}>
          ...
          {/* Items count */}
          <p style={s.countText}>
            {filteredItems.length} active lost{' '}
            {filteredItems.length === 1 ? 'item' : 'items'}
          </p>

          {/* Loading */}
          {loading && <div style={s.emptyState}>Loading items...</div>}
        ...
        <div style={s.modalOverlay} onClick={() => setModalOpen(false)}>
          <div style={s.modal} onClick={(e) => e.stopPropagation()}>
            ...
            <p style={s.modalSubtitle}>
              You're reporting that you found:{' '}
            ...
            <form onSubmit={handleModalSubmit} style={s.form}>
              <div style={s.field}>
                ...
                <LocationDropdown
                  ...
                  onChange={(val) =>
                    setModalData({ ...modalData, location: val })
                  }
              ...
              <div style={s.field}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setModalData({ ...modalData, heldAt: e.target.value })
                  }
                  onFocus={focusStyle}
                  onBlur={blurStyle}
                />
