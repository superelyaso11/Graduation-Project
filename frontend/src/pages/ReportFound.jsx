...
const STEPS = [
  ...
  { id: 2, label: 'Where & When', icon: MapPin },
  { id: 3, label: 'Description', icon: FileText },
];

// FIX: Moved Field outside the main function component to prevent re-instantiation & input focus bugs
...
const ReportFound = () => {
  ...
  const validateStep = () => {
    ...
    if (step === 2 && (!formData.location || !formData.dateFound)) {
  ...
  // Combined theme style config object to pass deep custom layout components down cleanly
  const themeStyles = {
    inputBg,
    border,
    textPri,
      ...
      >
        ...
        >
          ...
          >
                          ...
                          style={{
                            ...
                            backgroundColor: active
                              ...
                              : done
                                ? greenBg
                                : inputBg,
                            border: `1px solid ${active ? `${cyan}40` : done ? 'rgba(16,185,129,0.25)' : border}`,
                          }}
                        >
                          {done ? (
                            <CheckCircle2 size={13} style={{ color: green }} />
                          ...
                          <span
                            style={{
                              color: active ? cyan : done ? green : textMut,
                              fontSize: 12,
                              fontWeight: 600,
                            }}
                          >
            ...
            {/* Success state box banner notification */}
            <AnimatePresence>
              {success && (
                <motion.div
                  style={{
                ...
                >
                  ...
                  <p style={{ color: textMut, fontSize: 14, margin: 0 }}>
                    The owner will be notified immediately. You've earned
                    reputation points! Redirecting…
                  </p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            {!success && (
              ...
              >
                    ...
                    >
                      ...
                      {step === 2 && (
                        <>
                          ...
                          >
                            <Field label="DATE FOUND" textSub={textSub}>
                              <div
                                style={{
                                  position: 'relative',
                                  width: '100%',
                        ...
                        <>
                          <Field label="DESCRIPTION" textSub={textSub}>
                            <textarea
                              name="description"
                              rows={5}
                              placeholder="Describe the item — colour, brand, condition, any markings…"
                          ...
                          >
                            ...
                            >
                              ...
                              Reporting found items earns you reputation points
                              which build trust in the community.
                            </p>
                          </div>
                        </>
                      )}
                ...
                {/* Right Panel Sidebar Layout view box components */}
                <div
                  style={{
                    display: 'flex',
                    flexDirection: 'column',
                ...
                >
                  {/* Live preview section framework */}
                  <motion.div
                    style={{
                      borderRadius: 20,
                      padding: '1.25rem',
                  ...
                  {/* AI Prediction dynamic suggest layout framework */}
                  <AnimatePresence>
                    {aiSuggestion && (
                      <motion.div
                        style={{
                  ...
                  {/* Operational system actions preview checklist guidelines */}
                  <motion.div
                    style={{
                      borderRadius: 20,
                      padding: '1.25rem',
                  ...
                  >
                    ...
                    >
                      {[
                        {
                          icon: '🔍',
                          text: 'We match your report against active lost reports',
                        },
                        {
                          icon: '📩',
                          text: 'The owner is notified immediately if we find a match',
                        },
                        {
                          icon: '🤝',
                          text: 'You coordinate handover directly through our chat',
                        },
                        {
                          icon: '⭐',
                          text: 'You earn reputation points when the item is claimed',
                        },
                      ].map((tip) => (
                        <div
                          key={tip.text}
