...
const createLostItem = async (req, res) => {
    const {title, description, category, location, dateLost, imageUrl} = req.body
    ...
    try {
        const lostItems = await prisma.lostItem.findMany({
            where: {
                ...
                ...(location && {location: {contains: location, mode: 'insensitive'}}), // if location filter is provided
            },
            include: {
...
module.exports = { createLostItem, getLostItems, getLostItemById, getMyLostItems }