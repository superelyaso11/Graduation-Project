...
const getIncomingClaims = async (req, res) => {
    ...
    try{
        ...
        const claims = await prisma.claim.findMany({
            ...
            include: {
                claimant: { select: {id: true, name: true, email: true, points: true}},
                foundItem: true,
                lostItem: true,
            },
            orderBy: {createdAt: 'desc'},
...
module.exports = {createClaim, getMyClaims, getIncomingClaims, approveClaim, rejectClaim}